function Andrew(){
  ...
  nomePersonagem.innerHTML = '<strong>Andrew Reynolds</strong>'

  var imgPersonagem = window.document.getElementById('imgPersonagem')
  imgPersonagem.innerHTML = "<img src = './imagesPersonagens/andrew.jpg' width='150'>";

  var nascimento = window.document.getElementById('nascimento')
  nascimento.innerHTML = '<strong>Nascimento:</strong> 6 de Junho de 1978'

  var idade = window.document.getElementById('idade')
  idade.innerHTML = '<strong>Idade:</strong> 44 anos (2023)'
  ...
  cidade.innerHTML = '<strong>Cidade:</strong> Lakeland - Flórida - Eua'
  ...
  modalidade.innerHTML = '<strong>Altura:</strong> 1.87 m'
  ...
  stats.innerHTML = "<img src = './imagesStatsPersonagens/andrewStats.png' width='300' height='320'>";
...
/////////////////////////////////////////////////////////////////////////////////////////////
  ...
  nomeEspecias.innerHTML = '<strong>Nosegrab Tailslide</strong>'
  ...
  nomeEspecias2.innerHTML = '<strong>Triple HeelFlip</strong>'
  ...
  nomeEspecias3.innerHTML = '<strong>HardFlip Late Flip</strong>'
