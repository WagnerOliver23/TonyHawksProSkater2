function Eric(){
  ...
  nomePersonagem.innerHTML = '<strong>Eric Koston</strong>'

  var imgPersonagem = window.document.getElementById('imgPersonagem')
  imgPersonagem.innerHTML = "<img src = './imagesPersonagens/erickoston.jpg' width='150' height='150'>";

  var nascimento = window.document.getElementById('nascimento')
  nascimento.innerHTML = '<strong>Nascimento:</strong> 29 de Abril de 1975'

  var idade = window.document.getElementById('idade')
  idade.innerHTML = '<strong>Idade:</strong> 47 anos (2023)'

  var nacionalidade = window.document.getElementById('nacionalidade')
  nacionalidade.innerHTML = '<strong>Nacionalidade:</strong> Tailandês';

  var cidade = window.document.getElementById('cidade')
  cidade.innerHTML = '<strong>Cidade:</strong> Banguecoque - Tailândia'

  var paisRepresenta = window.document.getElementById('paisRepresenta')
  paisRepresenta.innerHTML = '<strong>Representante:</strong> Tailândia'

  var imgBandeiraRepresenta = window.document.getElementById('imgBandeiraRepresenta')
  imgBandeiraRepresenta.innerHTML = "<img src = './imagesBandeiraPaises/tailandia_bandeira.png' width='100'>";

  var modalidade = window.document.getElementById('altura')
  modalidade.innerHTML = '<strong>Altura:</strong> 1.83 m'
  ...
  stats.innerHTML = "<img src = './imagesStatsPersonagens/ericStats.png' width='300' height='320'>";
...
/////////////////////////////////////////////////////////////////////////////////////////////
  ...
  nomeEspecias2.innerHTML = '<strong>Indy FrontFlip</strong>'
  ...
  nomeEspecias3.innerHTML = 'Pizza Guy'
