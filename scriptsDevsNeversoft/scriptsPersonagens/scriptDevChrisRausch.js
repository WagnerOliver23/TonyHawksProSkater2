function Chris(){
  ...
  nomePersonagem.innerHTML = '<strong>Chris Rausch</strong>'
  ...
  papel12.innerHTML = 'Business & Operations'

  /* Game 13 */
  var jogosCreditados=window.document.getElementById('game13')
  jogosCreditados.innerHTML = 'X-Men: Legends II - Rise of Apocalypse (2005 on PSP)'

  var papel13=window.document.getElementById('papel13')
  papel13.innerHTML = 'Business and Operations'
  ...
  papel14.innerHTML = 'Additional Programming<br>Artwork and Level Design'
  ...
  papel15.innerHTML = 'Additional Level Design'
  ...
  jogosCreditados.innerHTML = 'Tony Hawks Pro Skater 3 (2002 on Game Boy Advance)'
