function Jason(){
  ...
  nomePersonagem.innerHTML = '<strong>Jason Uyeda</strong>'
  ...
  jogosCreditados.innerHTML = 'Call of Duty: Warzone (2020 on Windows)'

  var papel1=window.document.getElementById('papel1')
  papel1.innerHTML = '<strong>Design</strong>'


  /* Game 2 */
  var jogosCreditados=window.document.getElementById('game2')
  jogosCreditados.innerHTML = 'Call of Duty: Modern Warfare (2019 on PlayStation 4)'

  var papel2=window.document.getElementById('papel2')
  papel2.innerHTML = 'Design'
  ...
  papel3.innerHTML = 'Infinity Ward'

  /* Game 4 */
  var jogosCreditados=window.document.getElementById('game4')
  jogosCreditados.innerHTML = 'Call of Duty: Advanced Warfare (2014 on Xbox 360)'

  var papel4=window.document.getElementById('papel4')
  papel4.innerHTML = 'Additional Development<br>Support from Infinity Ward'
  ...
  papel5.innerHTML = 'Designed and Developed by<br>Infinity Ward, Neversoft'
  ...
  papel10.innerHTML = 'Designed & Developed'
  ...
  papel11.innerHTML = 'Designed and developed by Neversoft'
  ...
  jogosCreditados.innerHTML = 'Guitar Hero III: Legends of Rock (2007 on PlayStation 3)'

  var papel13=window.document.getElementById('papel13')
  papel13.innerHTML = 'Developed by Neversoft'
  ...
  papel14.innerHTML = 'Designed and Developed'
  ...
  jogosCreditados.innerHTML = 'Tony Hawks American Wasteland (Collectors Edition 2005 on PS2) '
