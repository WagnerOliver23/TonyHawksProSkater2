function Ryan(){
  ...
  nomePersonagem.innerHTML = '<strong>RYAN MCHMAHON</strong>'

  var imgPersonagem = window.document.getElementById('imgPersonagem')
  imgPersonagem.innerHTML = "<img src = './imagesDevsNeversoft/ryanMchmahon.jpg' width='150'>";

  var nascimento = window.document.getElementById('nascimento')
  nascimento.innerHTML = '<strong>Nascimento:</strong> 7 de outubro de 1974'

  var idade = window.document.getElementById('idade')
  idade.innerHTML = '<strong>Idade:</strong> 48 anos (2023)'

  var nacionalidade = window.document.getElementById('nacionalidade')
  nacionalidade.innerHTML = '<strong>Nacionalidade:</strong> Dinamarquês'

  var cidade = window.document.getElementById('cidade')
  cidade.innerHTML = '<strong>Cidade:</strong> Copenhage - Dinamarca'

  var paisRepresenta = window.document.getElementById('paisRepresenta')
  paisRepresenta.innerHTML = '<strong>Representante:</strong> Dinamarca'

  var imgBandeiraRepresenta = window.document.getElementById('imgBandeiraRepresenta')
  imgBandeiraRepresenta.innerHTML = "<img src = './imagesBandeiraPaises/dinamarca_bandeira.png' width='100'>";

  var modalidade = window.document.getElementById('altura')
  modalidade.innerHTML = '<strong>Altura:</strong> 1.80 m'
  ...
  stats.innerHTML = "<img src = './imagesStatsPersonagens/runestats.png' width='300' height='320'>";
...
////////////////////////////////////////////////////////////////////////////////////////////
  ...
  nomeGrabTricks4.innerHTML = '<strong>Indy Stiffy</strong>'
  ...
  nomeGrabTricks6.innerHTML = '<strong>Judo</strong>'
...
/////////////////////////////////////////////////////////////////////////////////////////////
  ...
  nomeEspecias.innerHTML = '<strong>One Foot Bluntslide</strong>'
  ...
  nomeEspecias2.innerHTML = '<strong>Kickflip 1 Foot Tail</strong>'
