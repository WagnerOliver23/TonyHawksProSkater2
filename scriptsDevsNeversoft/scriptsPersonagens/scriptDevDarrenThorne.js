function Darren(){
    ...
    nomePersonagem.innerHTML = '<strong>Darren Thorne</strong>'
    ...
    jogosCreditados.innerHTML = 'Guitar Hero III: Legends of Rock (2007 on Wii)'
  
    var papel1=window.document.getElementById('papel1')
    papel1.innerHTML = '<strong>Developed by Neversoft</strong>'
    ...
    papel2.innerHTML = 'Additional Art, Design<br>Programming and Production'
    ...
    papel3.innerHTML = 'Designed and Developed'
    ...
    papel4.innerHTML = 'Development Team'
    ...
    papel5.innerHTML = 'Development Team'
    ...
    papel6.innerHTML = 'Development Team'
  
    /* Game 7 */
    var jogosCreditados=window.document.getElementById('game7')
    jogosCreditados.innerHTML = 'Tony Hawks American Wasteland (2005 on GameCube)'
  
    var papel7=window.document.getElementById('papel7')
    papel7.innerHTML = 'Development Team'
    ...
    papel9.innerHTML = 'Neversoft Support'
  
    /* Game 10 */
    var jogosCreditados=window.document.getElementById('game10')
    jogosCreditados.innerHTML = 'Tony Hawks Underground 2 (2004 on GameCube)'
  
    var papel10=window.document.getElementById('papel10')
    papel10.innerHTML = 'Neversoft Support'
    ...
    papel11.innerHTML = 'Neversoft Development Team'
    ...
    papel12.innerHTML = 'Neversoft THPS4 Team'
    ...
    papel13.innerHTML = 'In alphabetical order'
    ...
    jogosCreditados.innerHTML = 'F-16 Multirole Fighter (1998 on Windows)'
